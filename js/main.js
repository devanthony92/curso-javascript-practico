...
const shoppingDetails = document.querySelector('#shoppingCarContainer');
...
function toggleDescktopMenu(){
    ...
    let isOpenProductDetails = productDetailContainer.classList.contains('inactive');
    
    if (!isOpenshoppingDetails){
        shoppingDetails.classList.add('inactive');  
    }
    if (!isOpenProductDetails){
...
function showProductDetail(){
    let isOpenShoppingCart = shoppingDetails.classList.contains('inactive');
    let isOpenDesktopMenu = desktopMenu.classList.contains('inactive');
    let isOpenMobileMenu = toggleMobile.classList.contains('inactive');
